...
public class ControllerConfig {
  ...
  public String getWebControllerServerIp() {
    return get("web_controller_server_ip", "192.168.1.9");
  }

  public void setWebControllerServerIp(String ip) {
    set("web_controller_server_ip", ip);
  }
}
